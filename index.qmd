...
For this assignment I looked at the song **"Op de block"** by Kevin and Emms. I used a chromagram and two self-similarity matrices to see how the song is structured and which notes dominate the track.
...
| Pitch features | Librosa CQT |
| Self-similarity | Librosa |
| Plots | R / ggplot2 |
| Dashboard | Quarto |
