...
:::: {.card title="Tempogram"}
![](tempogram.png)
::::

### Column {width=35%}

:::: {.card title="Tempo and Rhythm Breakdown"}
This tempogram visualizes the rhythmic foundation of "Op de block." Because the track is built on a looping hip-hop beat, the graph displays a strong, continuous horizontal band of energy at its primary tempo.

Compared to the chromagram, which showed clear differences between verses and the hook when Kevin and Emms switch vocals, the tempo itself stays tightly anchored. This steady, nearly unchanging BPM gives the song the driving backbone typical of Dutch hip-hop, keeping the vocal lines in the same rhythmic pocket throughout almost the entire track.
::::
